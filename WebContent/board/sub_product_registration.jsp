			...
			<div class="header">
				...
				<div class="loginbar_wrap after">
					<ul>
						...
						<li class ="loginbar"><a id="active_hover" href="productInfo.do?id=<%=custVo.getCus_id()%>" class="bar">상품등록</a></li>
				...
				<div id="wrapper">
					...
					<form id="uploadFile" method="post" enctype="multipart/form-data" action="/CFMS/productRegistration.do">
						<div class="regi_form">
							...
							<div class="regi_row">
								<label>소비자가격</label>
								<input type="text" id="rprice" name="rprice" placeholder="반드시 숫자만 입력하세요!">
							</div>
							<div class="regi_row">
								<label>판매가격</label>
								<input type="text" id="sprice" name="sprice" placeholder="반드시 숫자만 입력하세요!">
							</div>
							<div class="regi_row">
								<label>내용</label>
