...
$(function(){
	...
	code +='<tr>';
	code +='<td height=20 align= center bgcolor=gray><font color=black>글쓰기</font></td>';
	code +='</tr>';
	code +='<tr>';
	...
	code+='<tr>';
	code+='<td>내용</td>';
	code+='<td><input type = text id="cont" name="cont" style="width : 490px; height : 500px;" value=""></td>';
	code+='</tr>';
	code+='<tr>';
	code+='</table>';
	code+='<center>';
