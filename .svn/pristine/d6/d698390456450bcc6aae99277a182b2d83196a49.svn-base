...
$(function(){
	$.ajax({
		...
		success : function(res){
			...
			code +='<tr>';
			code +='<td class="t">' + "번호" +'</td>';
			code +='<td class="t">' + "제목" +'</td>';
			code +='<td class="t">' + "내용" +'</td>';
			code +='<td class="t">' + "날짜" +'</td>';
			code +='</tr>';
			code +='<tbody>';
		$.each(res, function(i,v){
			if(v.classify == 'FAQ'){
				code +='<tr>';
				code +='<td onclick=\"select('+v.seq+');\">' + v.seq + '</td>';
				code +='<td onclick=\"select('+v.seq+');\">' + v.title + '</td>';
				code +='<td onclick=\"select('+v.seq+');\">' + v.cont + '</td>';
				code +='<td onclick=\"select('+v.seq+');\">' + v.date + '</td>';
				code +='<tr>';
			}
		})
		code +='</tbody>';
